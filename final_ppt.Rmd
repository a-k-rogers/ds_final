...
```
The anova run on the nested models demonstrated that the partial-pooling model is the best for the data. Thus, I will discuss the results of that model in the following slides.
